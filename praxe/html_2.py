...
form: HTMLElement = HTMLElement(
    ...
    HTMLElement(
        "label",
        "Popis: " + HTMLElement("input", type="text", name="popis").render(),
    ).render()
    + HTMLElement(
        "label",
        "Cena: " + HTMLElement("input", type="text", name="cena").render(),
    ).render()
    + HTMLElement(
        "label",
        "Množství: " + HTMLElement("input", type="text", name="množství").render(),
    ).render()
    + HTMLElement("input", type="submit", value="Odeslat").render(),
